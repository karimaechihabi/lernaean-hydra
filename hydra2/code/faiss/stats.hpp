...
struct stats_info {
        ...
        double idx_training_total_input_time;  
        double idx_training_total_output_time;
        double idx_training_total_cpu_time;
        double idx_training_total_time;

        unsigned long long idx_training_total_seq_input_count;
        unsigned long long idx_training_total_seq_output_count;
        unsigned long long idx_training_total_rand_input_count;
        unsigned long long idx_training_total_rand_output_count;
        ...
        unsigned int query_file_position;
...
inline void stats_init(void)
{
    ...
    /*IDX_TRAINING_TOTAL STATISTICS*/
    stats.idx_training_total_input_time = 0;  
    stats.idx_training_total_output_time = 0;
    stats.idx_training_total_cpu_time = 0;
    stats.idx_training_total_time = 0;

    stats.idx_training_total_seq_input_count = 0;
    stats.idx_training_total_seq_output_count = 0;
    stats.idx_training_total_rand_input_count = 0;
    stats.idx_training_total_rand_output_count = 0;    
...
inline void stats_update_idx_training_stats(void)
{
  stats.idx_training_total_time = stats.counters.partial_time;
  stats.idx_training_total_input_time = stats.counters.partial_input_time;  
  stats.idx_training_total_output_time = stats.counters.partial_output_time;
  stats.idx_training_total_cpu_time = stats.counters.partial_time -stats.counters.partial_input_time - stats.counters.partial_output_time;

  stats.idx_training_total_seq_input_count = stats.counters.partial_seq_input_count;
  stats.idx_training_total_seq_output_count = stats.counters.partial_seq_output_count;
  stats.idx_training_total_rand_input_count = stats.counters.partial_rand_input_count;
  stats.idx_training_total_rand_output_count = stats.counters.partial_rand_output_count;
}

inline void stats_update_query_stats(double dist, unsigned long long bytes_read, unsigned int file_pos)
{
