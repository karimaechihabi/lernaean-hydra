...
static void
test_approx_bis(ts_type *massQ, size_t vecsize, size_t qsize, HierarchicalNSW<ts_type> &appr_alg, size_t vecdim,
...
void
test_vs_recall_bis(ts_type *massQ, size_t vecsize, size_t qsize, HierarchicalNSW<ts_type> &appr_alg, size_t vecdim,
		   vector<std::priority_queue<std::pair<ts_type, labeltype >>> &answers, size_t k, char * queries) {
    ...
    for (size_t ef : efs) {
        ...
        test_approx_bis(massQ, vecsize, qsize, appr_alg, vecdim, answers, k, queries);
...
void sift_test1B() {
    ...
    char path_gt[1024];
    char *path_q = "/home/karimae/data/real/bigann/bigann_query.bvecs";
    char *path_data = "/home/karimae/data/real/bigann/bigann_base.bvecs";
    sprintf(path_index, "sift1b_%dm_ef_%d_M_%d.bin", subset_size_milllions, efConstruction, M);

    sprintf(path_gt, "/home/karimae/data/real/bigann/gnd/idx_%dM.ivecs", subset_size_milllions);
