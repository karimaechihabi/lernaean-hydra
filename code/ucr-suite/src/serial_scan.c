...
int main (int argc, char **argv)
{
        ...
        switch (c)
        {
            ...
            case 'h':
                printf("Usage:\n\
                       ...
                       \t--subsequence-matching \t\tSet to perform subsequence matching. Not supported currently.\n\
                       \t--help\n\n");
                return 0;
                break;
    ...
    if (!calc_tlb)
    {
      serial_scan(dataset, dataset_size,queries, queries_size, timeseries_size,minimum_distance,stats);      
    }
